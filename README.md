...
The project is being implemented as a standalone TypeScript MCP server. The current local milestone is L07 in progress: L06 review flow plus a local LoRA upload/binding contract. Cloud availability remains unverified.
